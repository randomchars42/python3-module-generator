...
sed -i "s/\$PACKAGENAME/$package_name/g" "$package_dir/run.sh"
...
sed -i "s/\$PACKAGENAME/$package_name/g" "$package_dir/README.md"
...
sed -i "s/\$PACKAGENAME/$package_name/g" "$package_dir/setup.py"
...
echo -e " - check if the license (The Unlicense) suits your needs and intentions"
echo -e "Get some more information:"
echo -e " - https://packaging.python.org/guides/distributing-packages-using-setuptools/#setup-py"
echo -e " - https://packaging.python.org/tutorials/packaging-projects/"
echo -e " - https://github.com/pypa/sampleproject"
